...
//        sessionManagement.removeSession();
        Constants.setSharedString("userId"," ",Faculty.this);
        Constants.setSharedString("password"," ",Faculty.this);
        Constants.setSharedString("email"," ",Faculty.this);
        Constants.setSharedString("name"," ",Faculty.this);
        Constants.userId=" ";
        Constants.password=" ";
        Constants.email="";
        Constants.name="";
        Toast.makeText(Faculty.this, "LOGGED OUT", Toast.LENGTH_SHORT).show();
        MoveToGuestHome();
